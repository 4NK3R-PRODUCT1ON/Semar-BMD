...
const dn = args.join(' ')
const nomorOwner = ['6283826125112']
...
//©from: dennis
case 'grafiti':
if (!dn) return reply(`Silahkan masukkan nomor!\nContoh: ${prefix}grafiti teks|teks`)
teks1 = q.split("|")[0]
teks2 = q.split("|")[1]
maker.textpro("https://textpro.me/create-a-cool-graffiti-text-on-the-wall-1010.html", [
    `${teks1}`,`${teks2}`])
  .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by zixone` }, { quoted: m }))
  .catch((err) => console.log(err));
   break
case 'menu':
if (!dn) return reply(`BOT BY ZIXONE
-> ${prefix}add
-> ${prefix}grafiti
-> ${prefix}call
-> ${prefix}google
...
break
case 'google': {
if (!args[0]) return reply(`Example: ${prefix}google siapa saya`)
...
console.log(e)
semar.sendMessage("6283826125112@s.whatsapp.net", {text:e})}}